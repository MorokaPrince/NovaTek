      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">NovaTek Consulting</h3>
            <p className="text-gray-300 mb-4">
              Delivering innovative technology solutions and exceptional consulting services
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>Email: info@novatekconsulting.com</li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} NovaTek Consulting. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
